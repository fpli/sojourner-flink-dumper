...
public class RheosTrackEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public RheosTrackEvent(RheosHeader rheosHeader, AutoTrackEvent autoTrackEvent) {
   ...
   */
  public static RheosTrackEvent.Builder newBuilder() {
    return new RheosTrackEvent.Builder();
  }
   ...
   * @return A new RheosTrackEvent RecordBuilder
   */
  public static RheosTrackEvent.Builder newBuilder(RheosTrackEvent.Builder other) {
    return new RheosTrackEvent.Builder(other);
  }
   ...
   * @return A new RheosTrackEvent RecordBuilder
   */
  public static RheosTrackEvent.Builder newBuilder(RheosTrackEvent other) {
    return new RheosTrackEvent.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RheosTrackEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(RheosTrackEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(RheosTrackEvent other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.rheosHeader)) {
        this.rheosHeader = data().deepCopy(fields()[0].schema(), other.rheosHeader);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public RheosTrackEvent.Builder setRheosHeader(RheosHeader value) {
     ...
     * @return This builder.
     */
    public RheosTrackEvent.Builder setRheosHeaderBuilder(RheosHeader.Builder value) {
      clearRheosHeader();
    ...
    /**
      ...
      * @return This builder.
      */
    public RheosTrackEvent.Builder clearRheosHeader() {
      rheosHeader = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public RheosTrackEvent.Builder setAutoTrackEvent(AutoTrackEvent value) {
     ...
     * @return This builder.
     */
    public RheosTrackEvent.Builder setAutoTrackEventBuilder(AutoTrackEvent.Builder value) {
      clearAutoTrackEvent();
    ...
    /**
      ...
      * @return This builder.
      */
    public RheosTrackEvent.Builder clearAutoTrackEvent() {
      autoTrackEvent = null;
