...
public class SessionizedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 8: context = (com.ebay.epic.common.model.Context)value$; break;
    case 9: trackable = (com.ebay.epic.common.model.Trackable)value$; break;
    case 10: activity = (com.ebay.epic.common.model.Activity)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SessionizedEvent>
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.common.model.SessionizedEvent.Builder setGlobalSessionId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ebay.epic.common.model.SessionizedEvent.Builder clearGlobalSessionId() {
    ...
    public SessionizedEvent build() {
      try {
        ...
        if (contextBuilder != null) {
          ...
          record.context = fieldSetFlags()[8] ? this.context : (com.ebay.epic.common.model.Context) defaultValue(fields()[8]);
        }
        if (trackableBuilder != null) {
          record.trackable = this.trackableBuilder.build();
        } else {
          record.trackable = fieldSetFlags()[9] ? this.trackable : (com.ebay.epic.common.model.Trackable) defaultValue(fields()[9]);
        }
        if (activityBuilder != null) {
          record.activity = this.activityBuilder.build();
        } else {
          record.activity = fieldSetFlags()[10] ? this.activity : (com.ebay.epic.common.model.Activity) defaultValue(fields()[10]);
        }
        return record;
